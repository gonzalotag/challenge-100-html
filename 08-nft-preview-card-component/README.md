# NFT Preview Card Component - 100daysofprojects
...
Codificar un **componente de tarjeta vista previa** con efecto `overlay`, usando HTML, CSS y JavaScript, y lograr que se parezca lo más posible al diseño.
